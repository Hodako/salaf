...
/**
 * A customizable select component built on Radix UI Select primitive.
 * 
 * Provides a dropdown interface for selecting from a list of options, 
 * with support for groups, labels, and custom triggers.
 */
...
/**
 * Container for the Select dropdown content.
 */
...
/**
 * Label component for organizing items within a Select dropdown.
 */
...
/**
 * Visual separator between groups or items in a Select dropdown.
 */
...
/**
 * Button for scrolling up through long Select content.
 */
...
/**
 * Button for scrolling down through long Select content.
 */
