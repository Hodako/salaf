...
/**
 * Function for generating button class names based on variants and sizes.
 */
...
/**
 * A versatile button component built with Radix UI Slot.
 * 
 * Supports multiple variants (default, destructive, outline, secondary, ghost, link) 
 * and sizes (default, xs, sm, lg, icon). Can be rendered as a different element 
