...
/**
 * Root component for the Alert Dialog system.
 */
...
/**
 * Portal for rendering the Alert Dialog outside the main DOM tree.
 */
...
/**
 * Footer section of the Alert Dialog, typically for action and cancel buttons.
 */
...
/**
 * Media section (icon, image) for the Alert Dialog.
 */
